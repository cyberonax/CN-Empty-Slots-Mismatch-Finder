...
Aluminum, Coal, Gold, Iron, Lead, Lumber, Marble, Oil, Pigs, Rubber, Uranium, Water""",
                ...
                with st.expander("Summary Overview"):
                    ...
                    st.markdown(f"#### Total Peacetime Mismatch among Complete Trade Circles: {total_peace_mismatch}")
                    st.markdown(f"#### Wartime Mismatch among Complete Trade Circles: {unique_wartime_mismatch} ({wartime_mismatch_percentage:.2f}%)")
                    st.markdown('---')
