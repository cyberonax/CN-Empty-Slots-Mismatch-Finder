...
def main():
    ...
    if st.session_state.password_verified:
        if st.button("Download and Display Nation Statistics"):
            with st.spinner("Constructing download link and retrieving data..."):
                ...
                if df is not None:
                    ...
                    # Save the full dataset to session state so that it is not lost when filtering changes.
        ...
        if "df" in st.session_state and st.session_state.df is not None:
            ...
            # -----------------------
            # Instead of using st.session_state.filtered_csv, use the filtered DataFrame directly.
            if "filtered_df" in st.session_state:
                df_to_use = st.session_state.filtered_df.copy()
            else:
                df_to_use = st.session_state.df.copy()
            ...
            if "Alliance" in st.session_state.df.columns:
